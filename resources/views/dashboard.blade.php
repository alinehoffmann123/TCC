...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-light transform hover:scale-105 transition-all duration-300 animate-fade-in animate-delay-200">
            ...
            <p class="text-5xl font-extrabold text-bordo-dark">150</p>
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-light transform hover:scale-105 transition-all duration-300 animate-fade-in animate-delay-300">
            ...
            <p class="text-5xl font-extrabold text-bordo-dark">03</p>
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-light transform hover:scale-105 transition-all duration-300 animate-fade-in animate-delay-400">
            ...
            <p class="text-5xl font-extrabold text-bordo-dark">05</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-light animate-fade-in animate-delay-500">
            <h3 class="text-xl font-semibold text-gray-dark mb-4">Evolução de Alunos (Anual)</h3>
            <div class="h-64 bg-gray-50 border border-gray-light rounded-lg flex items-center justify-center text-gray-dark/60">
                <p>Gráfico de Linhas (Placeholder)</p>
            </div>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-light animate-fade-in animate-delay-500">
            <h3 class="text-xl font-semibold text-gray-dark mb-4">Distribuição de Faixas</h3>
            <div class="h-64 bg-gray-50 border border-gray-light rounded-lg flex items-center justify-center text-gray-dark/60">
                <p>Gráfico de Pizza (Placeholder)</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-light animate-fade-in animate-delay-400">
            ...
            <ul class="space-y-4">
                <li class="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                    <div class="w-8 h-8 rounded-full bg-bordo-dark flex items-center justify-center text-white text-sm font-bold flex-shrink-0">JS</div>
                    <div>
                        <p class="text-gray-dark font-medium">João Silva <span class="text-gray-dark/70 font-normal">realizou o exame de faixa branca.</span></p>
                        <p class="text-gray-dark/50 text-xs mt-1">Há 10 minutos</p>
                    </div>
                </li>
                <li class="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                    <div class="w-8 h-8 rounded-full bg-gray-600 flex items-center justify-center text-white text-sm font-bold flex-shrink-0">NT</div>
                    <div>
                        <p class="text-gray-dark font-medium">Nova turma <span class="text-gray-dark/70 font-normal">de iniciantes adicionada para terças e quintas.</span></p>
                        <p class="text-gray-dark/50 text-xs mt-1">Há 1 hora</p>
                    </div>
                </li>
                <li class="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                    <div class="w-8 h-8 rounded-full bg-bordo-dark flex items-center justify-center text-white text-sm font-bold flex-shrink-0">MS</div>
                    <div>
                        <p class="text-gray-dark font-medium">Maria Souza <span class="text-gray-dark/70 font-normal">pagamento de mensalidade confirmado.</span></p>
                        <p class="text-gray-dark/50 text-xs mt-1">Ontem</p>
                    </div>
                </li>
            </ul>
        </div>
