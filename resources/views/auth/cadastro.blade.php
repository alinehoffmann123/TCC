    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-bordo-dark via-bordo-dark to-black text-white p-12 flex-col justify-center relative overflow-hidden shadow-2xl">
        ...
        <div class="max-w-lg relative z-10">
            <div class="mb-8">
                ...
                <h1 class="text-4xl font-bold mb-4 drop-shadow-lg">Sistema de Gestão</h1>
                <h2 class="text-2xl text-white/90 mb-6 drop-shadow-md">Academia de Jiu-Jitsu</h2>
            </div>
            <div class="mb-8">
        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <div class="bg-white border border-gray-light shadow-2xl shadow-bordo-dark/10 backdrop-blur-sm rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('cadastro') }}" class="space-y-6">
                        @csrf
                        <div class="space-y-2">
                            <label for="name" class="text-gray-dark font-medium block">Nome Completo</label>
                            <div class="relative">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <svg id="eye-closed-password_confirmation" class="h-4 w-4 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21"></path>
                                    </svg>
                                </button>
                            </div>
                        ...
                        <div class="text-center text-sm text-gray-dark/70">
                            Já tem uma conta?
                            <a href="{{ route('login') }}" class="text-bordo-dark hover:text-bordo-hover hover:underline font-medium transition-colors ml-1">
                                Entrar
                            </a>
                        </div>
                    </form>
