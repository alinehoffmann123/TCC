                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                placeholder="seu@email.com" class="pl-10 w-full px-3 py-2 border border-gray-light rounded-md focus:outline-none focus:ring-2 focus:ring-bordo-dark focus:border-bordo-dark text-gray-dark" required autofocus
                                >
                            </div>
                        </div>
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                class="pl-10 pr-10 w-full px-3 py-2 border border-gray-light rounded-md focus:outline-none focus:ring-2 focus:ring-bordo-dark focus:border-bordo-dark text-gray-dark" required>
                                <button  type="button"  onclick="jVisualizarDadosSenhas('password')" class="absolute right-3 top-3 text-gray-dark/50 hover:text-bordo-dark transition-colors">
                        ...
                        <button type="submit" class="w-full bg-bordo-dark hover:bg-bordo-hover text-white font-semibold py-3 px-4 rounded-md transition-colors duration-200">
                            Entrar
                        </button>
                        <div class="relative">
